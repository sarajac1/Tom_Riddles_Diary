...
Konversationen ska efterlikna den som sker mellan Harry Potter och Tom Riddle, via skrift i en fysisk dagbok, se .txt-
filen för utdrag från boken.

För mer information om frågorna och möjliga svar, se facit. Annars är tanken att du bor kunna hänga med i botens flöde.
...
mening. Om det inte matchas så får du ett lämpligt meddelande med möjlighet att fortsätta konversationen med chatbot.

Boten kommer sedan att fråga om du vill veta mer om de händelser som skedde på skolan.
